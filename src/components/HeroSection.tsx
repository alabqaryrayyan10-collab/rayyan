...
export default function HeroSection() {
  ...
  const socialLinks = [
    {
      icon: Github,
      href: "https://github.com/alabqaryrayyan10-collab/rayyan.git",
      label: "GitHub",
    },
    {

    },
    { icon: Instagram, href: "https://www.instagram.com/abqary.rayyan?igsh=ODQ2bGE1N3ZzZWRp&utm_source=qr", label: "Instagram" },
  ];
  return (
    <section
      id="home"
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="flex flex-col lg:flex-row items-center justify-center gap-12">
          ...
          <div className="max-w-2xl text-center lg:text-left">
            ...
            >
              Saya membangun aplikasi web yang terbaik untuk saya perlihatkan hasil dari kerja saya dan membagi pengalaman yang bagus untuk semua agar semua ingin terinspirasi untuk membuatnya
            </motion.p>
